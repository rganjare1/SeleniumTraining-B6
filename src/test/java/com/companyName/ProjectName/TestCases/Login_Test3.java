...
public class Login_Test3 extends TestBase { // Inheritance --OOPs Java
	...
	public void login_Test3(Hashtable <String, String> testData) throws InterruptedException, IOException {
		...
		test = extents.startTest("Login_Test3");
		...
		driver.findElement(By.xpath(OR.getProperty("CreateAccntBtn1"))).click();
		//System.out.println("User clicked on CreateAccntBtn");	
		//test.log(LogStatus.PASS , "User clicked on CreateAccntBtn");
		//takeScreenShot_Pass();	
	//	test.log(LogStatus.FAIL , "User clicked on CreateAccntBtn");
		//takeScreenShot_Fail();
