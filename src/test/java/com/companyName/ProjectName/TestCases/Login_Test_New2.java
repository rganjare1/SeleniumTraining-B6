...
public class Login_Test_New2 extends TestBaseNew { // Inheritance --OOPs Java
	...
	public void login_Test_New2(Hashtable <String, String> testData) throws InterruptedException, IOException {
